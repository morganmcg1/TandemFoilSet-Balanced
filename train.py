...
class TransolverBlock(nn.Module):
    def __init__(self, num_heads, hidden_dim, dropout, act="gelu",
        ...
        # RMSNorm replaces LayerNorm: drops mean-centering and bias (β). Mean
        # centering is harmful when activations carry useful per-channel offsets
        # (gauge pressure, mean flow direction) — RMSNorm preserves them.

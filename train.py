...
print(f"Lion LR sweep: lr={cfg.lr} (2e-4; 1.33x the #2553 baseline lr=1.5e-4; 2x the #2524 baseline lr=1e-4); wd=3e-4, betas=(0.9, 0.99); baseline to beat: val_avg/mae_surf_p < 33.4935")
warmup_epochs = 3

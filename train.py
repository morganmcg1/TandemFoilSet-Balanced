...
optimizer = Lion(model.parameters(), lr=cfg.lr, betas=(0.9, 0.9999), weight_decay=cfg.weight_decay)
print(f"Lion optimizer: lr={cfg.lr}, betas=(0.9, 0.9999), weight_decay={cfg.weight_decay}")

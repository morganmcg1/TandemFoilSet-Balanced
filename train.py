...
class Config:
    ...
    n_hidden: int = 128  # Transolver hidden width (per-block)
    n_layers: int = 5  # Transolver depth (# of TransolverBlocks)
    slice_num: int = 64  # PhysicsAttention slice tokens per head

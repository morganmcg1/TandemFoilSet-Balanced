...
print(f"slice_num: 20 (down from 24, -17% slicing ops/block) — slice-routing-quality axis 3rd step after 64→32 (#1846) and 32→24 (#2307); tighter routing through fewer slice tokens; +0 params")

...
class DropPath(nn.Module):
    """Stochastic depth — drops the residual branch at training time
    with probability ``drop_prob``, scales by 1/(1-drop_prob) so the
    expected forward-pass output is unchanged."""

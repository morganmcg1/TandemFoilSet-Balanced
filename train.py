...
optimizer = torch.optim.AdamW(model.parameters(), lr=cfg.lr, weight_decay=cfg.weight_decay, betas=(0.9, 0.99), eps=1e-6)
print(f"AdamW betas: {optimizer.param_groups[0]['betas']}, eps: {optimizer.param_groups[0]['eps']}")
warmup_epochs = 4

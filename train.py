...
# nodes). At n_layers=8 the CUDAGraph Trees private pools (one per unique shape)
# overflow 95 GB (~68 GB pools observed before OOM in PR #435 round 1), so use
# mode="default" which keeps inductor compile but skips CUDAGraph capture.

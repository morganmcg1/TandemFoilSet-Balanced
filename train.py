...
def evaluate_split(model, loader, stats, surf_weight, device, huber_beta: float = 1.0) -> dict[str, float]:
...
class Config:
    ...
    huber_beta: float = 1.0  # Smooth-L1 transition point; lower = more L1, higher = more MSE

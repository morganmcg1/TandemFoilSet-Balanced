...
class Config:
    ...
    cosine_eta_min: float = 0.0  # minimum LR for cosine scheduler
...
tmax = cfg.cosine_tmax if cfg.cosine_tmax > 0 else MAX_EPOCHS
scheduler = torch.optim.lr_scheduler.CosineAnnealingLR(optimizer, T_max=tmax, eta_min=cfg.cosine_eta_min)
print(f"Scheduler: CosineAnnealingLR(T_max={tmax}, eta_min={cfg.cosine_eta_min})")

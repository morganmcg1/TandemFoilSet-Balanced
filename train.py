...
optimizer = Lion(model.parameters(), lr=cfg.lr, betas=(0.95, 0.99), weight_decay=cfg.weight_decay)
print(f"Lion optimizer: lr={cfg.lr}, betas=(0.95, 0.99), weight_decay={cfg.weight_decay}")

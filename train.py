...
print(f"surf_weight: {cfg.surf_weight} (UP from 10.0) — gradient rebalancing toward primary metric mae_surf_p; surf_weight=20 never tested (10 baseline, 30 prior LOSS under heavier config)")

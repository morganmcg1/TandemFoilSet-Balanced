...
class Config:
    ...
    swa_lr: float = 0.0  # SWALR target; 0 sentinel uses cfg.lr * 0.2 default
    swa_start_frac: float = 0.0  # SWA start fraction; 0 sentinel uses 0.75 default
...
swa_start_frac = cfg.swa_start_frac if cfg.swa_start_frac > 0 else 0.75

...
optimizer = Lion(model.parameters(), lr=cfg.lr, betas=(0.85, 0.999), weight_decay=cfg.weight_decay)
print(f"Lion optimizer: lr={cfg.lr}, betas=(0.85, 0.999), weight_decay={cfg.weight_decay}")

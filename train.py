...
print(f"slice_num: 16 (down from 24, -33% slicing ops/block) — routing-optimum search; mechanism is routing quality not budget (PR #2307 confirmed -9.61% at slice_num=24 with only -2% per-epoch cost)")

...
4. **CosineAnnealingWarmRestarts with T_mult=2** — broader loss landscape exploration with lengthening restart cycles; counter to fixed T_max.
...
9. **Fourier on velocity channels** — apply sinusoidal encoding to the velocity-field input dims in addition to spatial dims.

...
## Round-1 status snapshot (2026-05-15 14:33)

- **Merged (1):** #3094 Huber loss (alphonse) → new baseline `val_avg/mae_surf_p=111.531`.
- **Closed miss (1):** #3131 OneCycleLR (thorfinn) — see above.
- **Sent back for revision (1):** #3113 capacity scale-up (edward) — original 3-axis bump ran only 7 epochs in 30 min; revised to single-axis slice_num=64→96 on Huber baseline.
- **Still WIP (6):** #3278 alphonse, #3128 tanjiro, #3126 nezuko, #3122 frieren, #3117 fern, #3108 askeladd.
- **Idle (1):** thorfinn — needs Round-2 assignment.

## Operational notes

- 7 of 8 GPUs productively occupied; thorfinn idle awaiting new assignment.

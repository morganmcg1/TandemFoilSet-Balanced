...
| **#3493** | **alphonse** | **SOAP LR sweep {5e-4, 1e-3, 2e-3}** | **Optimization** | **WIP — running SOAP-baseline arms; notify when done** |
| **#3495** | **askeladd** | **SOAP precond_freq sweep {5, 10, 20}** | **Optimization** | **WIP — running SOAP-baseline arms; notify when done** |
| **#3497** | **tanjiro** | **Gradient clipping {1.0, 5.0, no-clip}** | **Optimization** | **WIP — running SOAP-baseline arms; notify when done** |

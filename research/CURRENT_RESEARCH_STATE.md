...
- **Last updated**: 2026-05-13 16:00 UTC (Wave 16: CLOSE #2281 tanjiro swiglu-320 stale vs ReGLU; ASSIGN #2377 tanjiro qk-norm-attention)
...
|---------|----|----|---------|--------|
| tanjiro | #2377 | qk-norm-attention | QK normalization on PhysicsAttention (DiT/ViT-22B/SD3 standard, fresh axis) | ASSIGNED |
...
8. **QK-norm attention** (tanjiro NEW): unit-normalize Q,K in PhysicsAttention + learnable per-head temperature; orthogonal architectural axis with strong evidence in modern transformers (DiT, ViT-22B, SD3)
